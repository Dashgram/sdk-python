...
### Added
- Manual payment tracking with `Dashgram.payment()`.
- Payment refund tracking with `Dashgram.refund_payment()`.
- Documentation and tests for payment/refund payloads and unsupported currency errors.
